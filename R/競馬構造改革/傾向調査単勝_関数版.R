...
url <- paste("R出力\\",format(Sys.Date(),"%Y%m%d"),"_","Tansho",BFKekkaNeraiStart ,"_",BFKekkaNeraiEnd ,"_",fitted,".txt",sep="")
sink(file(url, encoding = "UTF-8") ,split = TRUE)
url 
#____________________________________________________________________
#●関数
#____________________________________________________________________
keikoChosa_Tansho2<- function(KEIKODATA,STRNERAI,KEKKASTART,KEKKAEND,XHANNISTART,XHANNIEND,HANNISETEI){
...
for (i in 1:1){
  x1<-keikoChosa_Tansho2(UmahukuMat,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,0,13,1 )
  x2<-keikoChosa_Tansho2(subumahuku,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,0,13,1 )
...
for (i in 1:15){
  x1<-keikoChosa_Tansho2(UmahukuMat,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,haniStartMat[i],haniEndMat[i],wariaiMat[i])
  x2<-keikoChosa_Tansho2(subumahuku,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,haniStartMat[i],haniEndMat[i],wariaiMat[i])
...
for (i in 1:15){
  x1<-keikoChosa_Tansho2(UmahukuMat,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,0,50,200)
  x2<-keikoChosa_Tansho2(subumahuku,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,0,50,200)
...
for (i in 1:15){
  x1<-keikoChosa_Tansho2(UmahukuMat,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,0,50,20)
  x2<-keikoChosa_Tansho2(subumahuku,ikajoMat[i],BFKekkaNeraiStart,BFKekkaNeraiEnd,0,50,20)
