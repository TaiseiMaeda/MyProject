...
#●当てはめたデータの準備
#素の場合
#BFKekkaNeraiStart <- 14; BFKekkaNeraiEnd <- 29; checked <- kekkaCheck(UmahukuMat,BFKekkaNeraiStart,BFKekkaNeraiEnd)
...
#確認用
table(checkMat[5,]>0)[[2]] #勝
table(checkMat[5,]<0)[[2]] #負
table(checkMat[5,]==0)[[2]] #０
var(as.numeric(checkMat[5,]))

#sum(as.numeric(checkMat[5,]))
#sum(as.numeric(checkMat[4,]))
#sum(as.numeric(checkMat[3,]))
